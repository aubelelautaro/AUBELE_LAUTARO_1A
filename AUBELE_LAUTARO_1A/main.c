...
int main()
{
    ...
    /***********************************************
    EL PRESTAMO SIGUE ESTANDO DADO DE ALTA AUNQUE EL LIBRO SE HAYA DADO DE BAJA, ENTENDIENDO QUE AUNQUE YA NO HAYA CIERTO LIBRO, EL PRESTAMO DEL LIBRO SIGUE EN PIE
    EL LIBRO SIGUE ESTANDO DADO DE ALTA AUNQUE EL AUTO SE HAYA DADO DE BAJA, ENTENDIENDO QUE AUNQUE EL AUTOR SE HAYA DADO DE BAJA, EL LIBRO SIGUE SIENDO DE ESE AUTOR
    *************************************************/
    do
    {
        switch(menu())
